...
class Offsets:
    # Module: client.dll
    class ClientDll:
        dwEntityList = 0x66DDF48
        dwGameEntitySystem = 0x66DDF48
        dwGameEntitySystem_highestEntityIndex = 0x2090
        dwGlobalVars = 0x5C9B2D8
        dwLocalPlayerPawn = 0x5CA6508
        dwPrediction = 0x5CA6430
        dwSensitivity = 0x63845E8
        dwSensitivity_sensitivity = 0x58
        dwViewMatrix = 0x638C210
        dwViewRender = 0x638B8F8
    # Module: engine2.dll
    class Engine2Dll:
