...
const (
    ClientDll_dwEntityList = 0x64A5C50
    ClientDll_dwGameEntitySystem = 0x64A5C50
    ClientDll_dwGameEntitySystem_highestEntityIndex = 0x2090
    ClientDll_dwGlobalVars = 0x59FCFD8
    ClientDll_dwLocalPlayerPawn = 0x5A05F98
    ClientDll_dwPrediction = 0x5A05EC0
    ClientDll_dwViewMatrix = 0x612E1F0
    ClientDll_dwViewRender = 0x612D8B8
    ...
    Engine2Dll_dwWindowHeight = 0x90FF8C
    Engine2Dll_dwWindowWidth = 0x90FF88
