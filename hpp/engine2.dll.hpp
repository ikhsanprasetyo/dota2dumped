// printed at 2023-10-09 19:44:27.021078600 +07:00	from Dota2 7.34d
#pragma once
#include <cstdint>
...
namespace Offsets {
    ...
    namespace EventClientSendInput_t {
        constexpr uint32_t m_bFinalClientCommandTick = 0x0; // bool
        constexpr uint32_t m_nAdditionalClientCommandsToCreate = 0x4; // int32
    }
