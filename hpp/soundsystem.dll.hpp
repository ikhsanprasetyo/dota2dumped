// printed at 2023-11-02 22:16:17.854624300 +07:00	from Dota2 7.34d
#pragma once
#include <cstdint>
...
namespace Offsets {
    ...
    namespace CSosSoundEventGroupSchema {
        ...
        constexpr uint32_t m_branchPattern = 0x40; // CSosGroupBranchPattern
        constexpr uint32_t m_vActions = 0xB0; // CSosGroupActionSchema*[4]
    }
