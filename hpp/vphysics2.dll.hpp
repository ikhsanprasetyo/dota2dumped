// printed at 2023-11-02 22:16:17.827967800 +07:00	from Dota2 7.34d
#pragma once
#include <cstdint>
...
namespace Offsets {
    ...
    namespace FeRigidColliderIndices_t {
        ...
        constexpr uint32_t m_nCollisionPlaneIndex = 0x6; // uint16
    }
    ...
    namespace PhysFeModelDesc_t {
        ...
        constexpr uint32_t m_InitPose = 0x108; // CUtlVector< CTransform >
        constexpr uint32_t m_Rods = 0x120; // CUtlVector< FeRodConstraint_t >
        constexpr uint32_t m_Twists = 0x138; // CUtlVector< FeTwistConstraint_t >
        constexpr uint32_t m_AxialEdges = 0x150; // CUtlVector< FeAxialEdgeBend_t >
        constexpr uint32_t m_NodeInvMasses = 0x168; // CUtlVector< float32 >
        constexpr uint32_t m_CtrlOffsets = 0x180; // CUtlVector< FeCtrlOffset_t >
        constexpr uint32_t m_CtrlOsOffsets = 0x198; // CUtlVector< FeCtrlOsOffset_t >
        constexpr uint32_t m_FollowNodes = 0x1B0; // CUtlVector< FeFollowNode_t >
        constexpr uint32_t m_CollisionPlanes = 0x1C8; // CUtlVector< FeCollisionPlane_t >
        constexpr uint32_t m_NodeIntegrator = 0x1E0; // CUtlVector< FeNodeIntegrator_t >
        constexpr uint32_t m_SpringIntegrator = 0x1F8; // CUtlVector< FeSpringIntegrator_t >
        constexpr uint32_t m_SimdSpringIntegrator = 0x210; // CUtlVector< FeSimdSpringIntegrator_t >
        constexpr uint32_t m_WorldCollisionParams = 0x228; // CUtlVector< FeWorldCollisionParams_t >
        constexpr uint32_t m_LegacyStretchForce = 0x240; // CUtlVector< float32 >
        constexpr uint32_t m_NodeCollisionRadii = 0x258; // CUtlVector< float32 >
        constexpr uint32_t m_DynNodeFriction = 0x270; // CUtlVector< float32 >
        constexpr uint32_t m_LocalRotation = 0x288; // CUtlVector< float32 >
        constexpr uint32_t m_LocalForce = 0x2A0; // CUtlVector< float32 >
        constexpr uint32_t m_TaperedCapsuleStretches = 0x2B8; // CUtlVector< FeTaperedCapsuleStretch_t >
        constexpr uint32_t m_TaperedCapsuleRigids = 0x2D0; // CUtlVector< FeTaperedCapsuleRigid_t >
        constexpr uint32_t m_SphereRigids = 0x2E8; // CUtlVector< FeSphereRigid_t >
        constexpr uint32_t m_WorldCollisionNodes = 0x300; // CUtlVector< uint16 >
        constexpr uint32_t m_TreeParents = 0x318; // CUtlVector< uint16 >
        constexpr uint32_t m_TreeCollisionMasks = 0x330; // CUtlVector< uint16 >
        constexpr uint32_t m_TreeChildren = 0x348; // CUtlVector< FeTreeChildren_t >
        constexpr uint32_t m_FreeNodes = 0x360; // CUtlVector< uint16 >
        constexpr uint32_t m_FitMatrices = 0x378; // CUtlVector< FeFitMatrix_t >
        constexpr uint32_t m_FitWeights = 0x390; // CUtlVector< FeFitWeight_t >
        constexpr uint32_t m_ReverseOffsets = 0x3A8; // CUtlVector< FeNodeReverseOffset_t >
        constexpr uint32_t m_AnimStrayRadii = 0x3C0; // CUtlVector< FeAnimStrayRadius_t >
        constexpr uint32_t m_SimdAnimStrayRadii = 0x3D8; // CUtlVector< FeSimdAnimStrayRadius_t >
        constexpr uint32_t m_KelagerBends = 0x3F0; // CUtlVector< FeKelagerBend2_t >
        constexpr uint32_t m_CtrlSoftOffsets = 0x408; // CUtlVector< FeCtrlSoftOffset_t >
        constexpr uint32_t m_JiggleBones = 0x420; // CUtlVector< CFeIndexedJiggleBone >
        constexpr uint32_t m_SourceElems = 0x438; // CUtlVector< uint16 >
        constexpr uint32_t m_GoalDampedSpringIntegrators = 0x450; // CUtlVector< uint32 >
        constexpr uint32_t m_Tris = 0x468; // CUtlVector< FeTri_t >
        constexpr uint32_t m_nTriCount1 = 0x480; // uint16
        constexpr uint32_t m_nTriCount2 = 0x482; // uint16
        constexpr uint32_t m_nReservedUint8 = 0x484; // uint8
        constexpr uint32_t m_nExtraPressureIterations = 0x485; // uint8
        constexpr uint32_t m_nExtraGoalIterations = 0x486; // uint8
        constexpr uint32_t m_nExtraIterations = 0x487; // uint8
        constexpr uint32_t m_BoxRigids = 0x488; // CUtlVector< FeBoxRigid_t >
        constexpr uint32_t m_DynNodeVertexSet = 0x4A0; // CUtlVector< uint8 >
        constexpr uint32_t m_VertexSetNames = 0x4B8; // CUtlVector< uint32 >
        constexpr uint32_t m_RigidColliderPriorities = 0x4D0; // CUtlVector< FeRigidColliderIndices_t >
        constexpr uint32_t m_MorphLayers = 0x4E8; // CUtlVector< FeMorphLayerDepr_t >
        constexpr uint32_t m_MorphSetData = 0x500; // CUtlVector< uint8 >
        constexpr uint32_t m_VertexMaps = 0x518; // CUtlVector< FeVertexMapDesc_t >
        constexpr uint32_t m_VertexMapValues = 0x530; // CUtlVector< uint8 >
        constexpr uint32_t m_Effects = 0x548; // CUtlVector< FeEffectDesc_t >
        constexpr uint32_t m_LockToParent = 0x560; // CUtlVector< FeCtrlOffset_t >
        constexpr uint32_t m_LockToGoal = 0x578; // CUtlVector< uint16 >
        constexpr uint32_t m_DynNodeWindBases = 0x590; // CUtlVector< FeNodeWindBase_t >
        constexpr uint32_t m_flInternalPressure = 0x5A8; // float32
        constexpr uint32_t m_flDefaultTimeDilation = 0x5AC; // float32
        constexpr uint32_t m_flWindage = 0x5B0; // float32
        constexpr uint32_t m_flWindDrag = 0x5B4; // float32
        constexpr uint32_t m_flDefaultSurfaceStretch = 0x5B8; // float32
        constexpr uint32_t m_flDefaultThreadStretch = 0x5BC; // float32
        constexpr uint32_t m_flDefaultGravityScale = 0x5C0; // float32
        constexpr uint32_t m_flDefaultVelAirDrag = 0x5C4; // float32
        constexpr uint32_t m_flDefaultExpAirDrag = 0x5C8; // float32
        constexpr uint32_t m_flDefaultVelQuadAirDrag = 0x5CC; // float32
        constexpr uint32_t m_flDefaultExpQuadAirDrag = 0x5D0; // float32
        constexpr uint32_t m_flRodVelocitySmoothRate = 0x5D4; // float32
        constexpr uint32_t m_flQuadVelocitySmoothRate = 0x5D8; // float32
        constexpr uint32_t m_flAddWorldCollisionRadius = 0x5DC; // float32
        constexpr uint32_t m_flDefaultVolumetricSolveAmount = 0x5E0; // float32
        constexpr uint32_t m_nRodVelocitySmoothIterations = 0x5E4; // uint16
        constexpr uint32_t m_nQuadVelocitySmoothIterations = 0x5E6; // uint16
    }
    ...
    namespace RnCapsuleDesc_t {
        constexpr uint32_t m_Capsule = 0x10; // RnCapsule_t
    }
    ...
    namespace RnHullDesc_t {
        constexpr uint32_t m_Hull = 0x10; // RnHull_t
    }
    ...
    namespace RnHull_t {
        ...
        constexpr uint32_t m_Vertices = 0x68; // CUtlVector< Vector >
        constexpr uint32_t m_Edges = 0x80; // CUtlVector< RnHalfEdge_t >
        constexpr uint32_t m_Faces = 0x98; // CUtlVector< RnFace_t >
        constexpr uint32_t m_Planes = 0xB0; // CUtlVector< RnPlane_t >
        constexpr uint32_t m_nFlags = 0xC8; // uint32
        constexpr uint32_t m_pRegionSVM = 0xD0; // CRegionSVM*
    }

    namespace RnMeshDesc_t {
        constexpr uint32_t m_Mesh = 0x10; // RnMesh_t
    }
    ...
    namespace RnSphereDesc_t {
        constexpr uint32_t m_Sphere = 0x10; // RnSphere_t
    }

    namespace RnSphere_t {
        constexpr uint32_t m_vCenter = 0x0; // Vector
    ...
    namespace vphysics_save_cphysicsbody_t {
        constexpr uint32_t m_nOldPointer = 0xD0; // uint64
    }
}