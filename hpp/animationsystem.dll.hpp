// printed at 2023-10-04 22:59:41.934643400 +07:00	from Dota2 7.34c
#pragma once
#include <cstdint>
...
namespace Offsets {
    namespace AimMatrixOpFixedSettings_t {
        ...
        constexpr uint32_t m_fAngleIncrement = 0xBC; // float32
        constexpr uint32_t m_nSequenceMaxFrame = 0xC0; // int32
        constexpr uint32_t m_nBoneMaskIndex = 0xC4; // int32
        constexpr uint32_t m_bTargetIsPosition = 0xC8; // bool
    }
    ...
    namespace BoneDemoCaptureSettings_t {
        ...
        constexpr uint32_t m_flChainLength = 0x8; // float32
    }
    ...
    namespace CAimMatrixUpdateNode {
        ...
        constexpr uint32_t m_target = 0x148; // AnimVectorSource
        constexpr uint32_t m_paramIndex = 0x14C; // CAnimParamHandle
        constexpr uint32_t m_hSequence = 0x150; // HSequence
        constexpr uint32_t m_bResetChild = 0x154; // bool
        constexpr uint32_t m_bLockWhenWaning = 0x155; // bool
    }
    ...
    namespace CAnimDemoCaptureSettings {
        constexpr uint32_t m_rangeBoneChainLength = 0x0; // Vector2D
        constexpr uint32_t m_rangeMaxSplineErrorRotation = 0x8; // Vector2D
        constexpr uint32_t m_flMaxSplineErrorTranslation = 0x10; // float32
        constexpr uint32_t m_flMaxSplineErrorScale = 0x14; // float32
        ...
        constexpr uint32_t m_flMaxQuantizationErrorRotation = 0x20; // float32
        constexpr uint32_t m_flMaxQuantizationErrorTranslation = 0x24; // float32
        constexpr uint32_t m_flMaxQuantizationErrorScale = 0x28; // float32
        constexpr uint32_t m_flIkRotation_MaxQuantizationError = 0x2C; // float32
        constexpr uint32_t m_flIkTranslation_MaxQuantizationError = 0x30; // float32
        constexpr uint32_t m_baseSequence = 0x38; // CUtlString
        constexpr uint32_t m_nBaseSequenceFrame = 0x40; // int32
        constexpr uint32_t m_boneSelectionMode = 0x44; // EDemoBoneSelectionMode
        constexpr uint32_t m_bones = 0x48; // CUtlVector< BoneDemoCaptureSettings_t >
        constexpr uint32_t m_ikChains = 0x60; // CUtlVector< IKDemoCaptureSettings_t >
    }
    ...
    namespace CAnimDesc {
        ...
        constexpr uint32_t m_eventArray = 0x110; // CUtlVector< CAnimEventDefinition >
        constexpr uint32_t m_activityArray = 0x128; // CUtlVector< CAnimActivity >
        constexpr uint32_t m_hierarchyArray = 0x140; // CUtlVector< CAnimLocalHierarchy >
        constexpr uint32_t framestalltime = 0x158; // float32
        constexpr uint32_t m_vecRootMin = 0x15C; // Vector
        constexpr uint32_t m_vecRootMax = 0x168; // Vector
        constexpr uint32_t m_vecBoneWorldMin = 0x178; // CUtlVector< Vector >
        constexpr uint32_t m_vecBoneWorldMax = 0x190; // CUtlVector< Vector >
        constexpr uint32_t m_sequenceParams = 0x1A8; // CAnimSequenceParams
    }
    ...
    namespace CAnimEventDefinition {
        ...
        constexpr uint32_t m_flCycle = 0xC; // float32
        constexpr uint32_t m_EventData = 0x10; // KeyValues3
        constexpr uint32_t m_sLegacyOptions = 0x20; // CBufferString
        constexpr uint32_t m_sEventName = 0x30; // CGlobalSymbol
    }
    ...
    namespace CAnimParameterBase {
        ...
        constexpr uint32_t m_group = 0x20; // CUtlString
        constexpr uint32_t m_id = 0x28; // AnimParamID
        constexpr uint32_t m_componentName = 0x40; // CUtlString
        constexpr uint32_t m_bNetworkingRequested = 0x4C; // bool
        constexpr uint32_t m_bIsReferenced = 0x4D; // bool
    }
    ...
    namespace CAnimTagBase {
        constexpr uint32_t m_name = 0x18; // CGlobalSymbol
        constexpr uint32_t m_group = 0x20; // CGlobalSymbol
        constexpr uint32_t m_tagID = 0x28; // AnimTagID
        constexpr uint32_t m_bIsReferenced = 0x2C; // bool
    }

    namespace CAnimTagManagerUpdater {
        constexpr uint32_t m_tags = 0x18; // CUtlVector< CSmartPtr< CAnimTagBase > >
    }
    ...
    namespace CAudioAnimTag {
        constexpr uint32_t m_clipName = 0x38; // CUtlString
        constexpr uint32_t m_attachmentName = 0x40; // CUtlString
        constexpr uint32_t m_flVolume = 0x48; // float32
        constexpr uint32_t m_bStopWhenTagEnds = 0x4C; // bool
        constexpr uint32_t m_bStopWhenGraphEnds = 0x4D; // bool
        constexpr uint32_t m_bPlayOnServer = 0x4E; // bool
        constexpr uint32_t m_bPlayOnClient = 0x4F; // bool
    }

    namespace CBaseConstraint {
        constexpr uint32_t m_name = 0x28; // CUtlString
        constexpr uint32_t m_vUpVector = 0x30; // Vector
        constexpr uint32_t m_slaves = 0x40; // CUtlVector< CConstraintSlave >
        constexpr uint32_t m_targets = 0x58; // CUtlVector< CConstraintTarget >
    }
    ...
    namespace CBodyGroupAnimTag {
        constexpr uint32_t m_nPriority = 0x38; // int32
        constexpr uint32_t m_bodyGroupSettings = 0x40; // CUtlVector< CBodyGroupSetting >
    }
    ...
    namespace CBoneConstraintPoseSpaceBone {
        constexpr uint32_t m_inputList = 0x70; // CUtlVector< CBoneConstraintPoseSpaceBone::Input_t >
    }
    ...
    namespace CBoolAnimParameter {
        constexpr uint32_t m_bDefaultValue = 0x60; // bool
    }
    ...
    namespace CClothSettingsAnimTag {
        constexpr uint32_t m_flStiffness = 0x38; // float32
        constexpr uint32_t m_flEaseIn = 0x3C; // float32
        constexpr uint32_t m_flEaseOut = 0x40; // float32
        constexpr uint32_t m_nVertexSet = 0x48; // CUtlString
    }
    ...
    namespace CConcreteAnimParameter {
        constexpr uint32_t m_previewButton = 0x50; // AnimParamButton_t
        constexpr uint32_t m_eNetworkSetting = 0x54; // AnimParamNetworkSetting
        constexpr uint32_t m_bUseMostRecentValue = 0x58; // bool
        constexpr uint32_t m_bAutoReset = 0x59; // bool
        constexpr uint32_t m_bGameWritable = 0x5A; // bool
        constexpr uint32_t m_bGraphWritable = 0x5B; // bool
    }
    ...
    namespace CEnumAnimParameter {
        constexpr uint32_t m_defaultValue = 0x68; // uint8
        constexpr uint32_t m_enumOptions = 0x70; // CUtlVector< CUtlString >
    }
    ...
    namespace CFloatAnimParameter {
        constexpr uint32_t m_fDefaultValue = 0x60; // float32
        constexpr uint32_t m_fMinValue = 0x64; // float32
        constexpr uint32_t m_fMaxValue = 0x68; // float32
        constexpr uint32_t m_bInterpolate = 0x6C; // bool
    }
    ...
    namespace CFootFallAnimTag {
        constexpr uint32_t m_foot = 0x38; // FootFallTagFoot_t
    }
    ...
    namespace CFootstepLandedAnimTag {
        constexpr uint32_t m_FootstepType = 0x38; // FootstepLandedFootSoundType_t
        constexpr uint32_t m_OverrideSoundName = 0x40; // CUtlString
        constexpr uint32_t m_DebugAnimSourceString = 0x48; // CUtlString
        constexpr uint32_t m_BoneName = 0x50; // CUtlString
    }
    ...
    namespace CIntAnimParameter {
        constexpr uint32_t m_defaultValue = 0x60; // int32
        constexpr uint32_t m_minValue = 0x64; // int32
        constexpr uint32_t m_maxValue = 0x68; // int32
    }
    ...
    namespace CMaterialAttributeAnimTag {
        constexpr uint32_t m_AttributeName = 0x38; // CUtlString
        constexpr uint32_t m_AttributeType = 0x40; // MatterialAttributeTagType_t
        constexpr uint32_t m_flValue = 0x44; // float32
        constexpr uint32_t m_Color = 0x48; // Color
    }

    namespace CMaterialDrawDescriptor {
        constexpr uint32_t m_nPrimitiveType = 0x0; // RenderPrimitiveType_t
        constexpr uint32_t m_nBaseVertex = 0x4; // int32
        constexpr uint32_t m_nVertexCount = 0x8; // int32
        constexpr uint32_t m_nStartIndex = 0xC; // int32
        constexpr uint32_t m_nIndexCount = 0x10; // int32
        constexpr uint32_t m_flUvDensity = 0x14; // float32
        constexpr uint32_t m_vTintColor = 0x18; // Vector
        constexpr uint32_t m_flAlpha = 0x24; // float32
        constexpr uint32_t m_nFirstMeshlet = 0x2C; // uint32
        constexpr uint32_t m_nNumMeshlets = 0x30; // uint16
        constexpr uint32_t m_indexBuffer = 0xB8; // CRenderBufferBinding
        constexpr uint32_t m_material = 0xE0; // CStrongHandle< InfoForResourceTypeIMaterial2 >
    }
    ...
    namespace CMorphConstraint {
        constexpr uint32_t m_sTargetMorph = 0x70; // CUtlString
        constexpr uint32_t m_nSlaveChannel = 0x78; // int32
        constexpr uint32_t m_flMin = 0x7C; // float32
        constexpr uint32_t m_flMax = 0x80; // float32
    }
    ...
    namespace CMovementComponentUpdater {
        constexpr uint32_t m_movementModes = 0x30; // CUtlVector< CMovementMode >
        constexpr uint32_t m_motors = 0x48; // CUtlVector< CSmartPtr< CAnimMotorUpdaterBase > >
        constexpr uint32_t m_facingDamping = 0x60; // CAnimInputDamping
        constexpr uint32_t m_eDefaultFacingMode = 0x70; // FacingMode
        constexpr uint32_t m_nDefaultMotorIndex = 0x7C; // int32
        constexpr uint32_t m_bMoveVarsDisabled = 0x80; // bool
        constexpr uint32_t m_bNetworkPath = 0x81; // bool
        constexpr uint32_t m_bNetworkFacing = 0x82; // bool
        constexpr uint32_t m_paramHandles = 0x83; // CAnimParamHandle[30]
    }

    namespace CMovementMode {
        constexpr uint32_t m_name = 0x0; // CUtlString
        constexpr uint32_t m_flSpeed = 0x8; // float32
    }
    ...
    namespace CParticleAnimTag {
        constexpr uint32_t m_hParticleSystem = 0x38; // CStrongHandle< InfoForResourceTypeIParticleSystemDefinition >
        constexpr uint32_t m_particleSystemName = 0x40; // CUtlString
        constexpr uint32_t m_configName = 0x48; // CUtlString
        constexpr uint32_t m_bDetachFromOwner = 0x50; // bool
        constexpr uint32_t m_bStopWhenTagEnds = 0x51; // bool
        constexpr uint32_t m_bTagEndStopIsInstant = 0x52; // bool
        constexpr uint32_t m_attachmentName = 0x58; // CUtlString
        constexpr uint32_t m_attachmentType = 0x60; // ParticleAttachment_t
        constexpr uint32_t m_attachmentCP1Name = 0x68; // CUtlString
        constexpr uint32_t m_attachmentCP1Type = 0x70; // ParticleAttachment_t
    }
    ...
    namespace CPhysSurfaceProperties {
        ...
        constexpr uint32_t m_audioSounds = 0x48; // CPhysSurfacePropertiesSoundNames
        constexpr uint32_t m_audioParams = 0x88; // CPhysSurfacePropertiesAudio
    }
    ...
    namespace CQuaternionAnimParameter {
        constexpr uint32_t m_defaultValue = 0x60; // Quaternion
        constexpr uint32_t m_bInterpolate = 0x70; // bool
    }

    namespace CRagdollAnimTag {
        constexpr uint32_t m_nPoseControl = 0x38; // AnimPoseControl
        constexpr uint32_t m_flFrequency = 0x3C; // float32
        constexpr uint32_t m_flDampingRatio = 0x40; // float32
        constexpr uint32_t m_flDecayDuration = 0x44; // float32
        constexpr uint32_t m_flDecayBias = 0x48; // float32
        constexpr uint32_t m_bDestroy = 0x4C; // bool
    }
    ...
    namespace CRenderMesh {
        constexpr uint32_t m_sceneObjects = 0x10; // CUtlVectorFixedGrowable< CSceneObjectData >
        constexpr uint32_t m_constraints = 0xA0; // CUtlVector< CBaseConstraint* >
        constexpr uint32_t m_skeleton = 0xB8; // CRenderSkeleton
    }
    ...
    namespace CSceneObjectData {
        ...
        constexpr uint32_t m_drawCalls = 0x18; // CUtlVector< CMaterialDrawDescriptor >
        constexpr uint32_t m_drawBounds = 0x30; // CUtlVector< AABB_t >
        constexpr uint32_t m_meshlets = 0x48; // CUtlVector< CMeshletDescriptor >
        constexpr uint32_t m_vTintColor = 0x60; // Vector4D
    }
    ...
    namespace CSelectorUpdateNode {
        ...
        constexpr uint32_t m_eTagBehavior = 0xA0; // SelectorTagBehavior_t
        constexpr uint32_t m_bResetOnChange = 0xA4; // bool
        constexpr uint32_t m_bSyncCyclesOnChange = 0xA5; // bool
    }
    ...
    namespace CSeqS1SeqDesc {
        ...
        constexpr uint32_t m_nLocalWeightlist = 0x88; // int32
        constexpr uint32_t m_autoLayerArray = 0x90; // CUtlVector< CSeqAutoLayer >
        constexpr uint32_t m_IKLockArray = 0xA8; // CUtlVector< CSeqIKLock >
        constexpr uint32_t m_transition = 0xC0; // CSeqTransition
        constexpr uint32_t m_SequenceKeys = 0xC8; // KeyValues3
        constexpr uint32_t m_LegacyKeyValueText = 0xD8; // CBufferString
        constexpr uint32_t m_activityArray = 0xE8; // CUtlVector< CAnimActivity >
        constexpr uint32_t m_footMotion = 0x100; // CUtlVector< CFootMotion >
    }
    ...
    namespace CSequenceFinishedAnimTag {
        constexpr uint32_t m_sequenceName = 0x38; // CUtlString
    }
    ...
    namespace CSequenceUpdateNode {
        constexpr uint32_t m_paramSpans = 0x60; // CParamSpanUpdater
        constexpr uint32_t m_tags = 0x78; // CUtlVector< TagSpan_t >
        constexpr uint32_t m_hSequence = 0x94; // HSequence
        constexpr uint32_t m_playbackSpeed = 0x98; // float32
        constexpr uint32_t m_duration = 0x9C; // float32
        constexpr uint32_t m_bLoop = 0xA0; // bool
    }
    ...
    namespace CSetFacingUpdateNode {
        constexpr uint32_t m_facingMode = 0x68; // FacingMode
        constexpr uint32_t m_bResetChild = 0x6C; // bool
    }
    ...
    namespace CTiltTwistConstraint {
        constexpr uint32_t m_nTargetAxis = 0x70; // int32
        constexpr uint32_t m_nSlaveAxis = 0x74; // int32
    }
    ...
    namespace CTwistConstraint {
        constexpr uint32_t m_bInverse = 0x70; // bool
        constexpr uint32_t m_qParentBindRotation = 0x80; // Quaternion
        constexpr uint32_t m_qChildBindRotation = 0x90; // Quaternion
    }

    namespace CTwoBoneIKUpdateNode {
        constexpr uint32_t m_opFixedData = 0x70; // TwoBoneIKSettings_t
    }
    ...
    namespace CVectorAnimParameter {
        constexpr uint32_t m_defaultValue = 0x60; // Vector
        constexpr uint32_t m_bInterpolate = 0x6C; // bool
    }
    ...
    namespace CVirtualAnimParameter {
        constexpr uint32_t m_expressionString = 0x50; // CUtlString
        constexpr uint32_t m_eParamType = 0x58; // AnimParamType_t
    }
    ...
    namespace SolveIKChainPoseOpFixedSettings_t {
        ...
        constexpr uint32_t m_bMatchTargetOrientation = 0x18; // bool
    }
