// printed at 2023-11-07 22:14:11.257570800 +07:00	from Dota2 7.34d
#pragma once
#include <cstdint>
...
namespace Offsets {
    ...
    namespace CPulseCell_Inflow_Method {
        ...
        constexpr uint32_t m_Args = 0x98; // CUtlVector< CPulseRuntimeMethodArg >
    }
    ...
    namespace CPulseCell_Outflow_CycleShuffled_InstanceState_t {
        constexpr uint32_t m_Shuffle = 0x0; // CUtlVectorFixedGrowable< uint8 >
    ...
    namespace CPulseCell_Outflow_IntSwitch {
        ...
        constexpr uint32_t m_CaseOutflows = 0x58; // CUtlVector< CPulse_OutflowConnection >
    }
    ...
    namespace CPulseCell_Outflow_TestExplicitYesNo {
        ...
        constexpr uint32_t m_No = 0x58; // CPulse_OutflowConnection
    }
    ...
    namespace CPulseCell_Step_CallExternalMethod {
        ...
        constexpr uint32_t m_ExpectedArgs = 0x50; // CUtlVector< CPulseRuntimeMethodArg >
    }
    ...
    namespace CPulseGraphDef {
        ...
        constexpr uint32_t m_Chunks = 0x18; // CUtlVector< CPulse_Chunk* >
        constexpr uint32_t m_Cells = 0x30; // CUtlVector< CPulseCell_Base* >
        constexpr uint32_t m_Vars = 0x48; // CUtlVector< CPulse_Variable >
        constexpr uint32_t m_PublicOutputs = 0x60; // CUtlVector< CPulse_PublicOutput >
        constexpr uint32_t m_InvokeBindings = 0x78; // CUtlVector< CPulse_InvokeBinding* >
        constexpr uint32_t m_CallInfos = 0x90; // CUtlVector< CPulse_CallInfo* >
        constexpr uint32_t m_OutputConnections = 0xA8; // CUtlVector< CPulse_OutputConnection* >
    }

    namespace CPulseGraphInstance_TestDomain {
        constexpr uint32_t m_bIsRunningUnitTests = 0xD0; // bool
        constexpr uint32_t m_bExplicitTimeStepping = 0xD1; // bool
        constexpr uint32_t m_bExpectingToDestroyWithYieldedCursors = 0xD2; // bool
        constexpr uint32_t m_nNextValidateIndex = 0xD4; // int32
        constexpr uint32_t m_Tracepoints = 0xD8; // CUtlVector< CUtlString >
        constexpr uint32_t m_bTestYesOrNoPath = 0xF0; // bool
    }

    namespace CPulseGraphInstance_TestDomain_Derived {
        constexpr uint32_t m_nInstanceValueX = 0xF8; // int32
    }
    ...
    namespace CPulseTurtleGraphicsCursor {
        constexpr uint32_t m_Color = 0x188; // Color
        constexpr uint32_t m_vPos = 0x18C; // Vector2D
        constexpr uint32_t m_flHeadingDeg = 0x194; // float32
        constexpr uint32_t m_bPenUp = 0x198; // bool
    }
    ...
    namespace CPulse_InvokeBinding {
        ...
        constexpr uint32_t m_InstanceType = 0x30; // CPulseValueFullType
        constexpr uint32_t m_nSrcChunk = 0x40; // PulseRuntimeChunkIndex_t
        constexpr uint32_t m_nSrcInstruction = 0x44; // int32
    }
    ...
    namespace CTestDomainDerived_Cursor {
        constexpr uint32_t m_nCursorValueA = 0x188; // int32
        constexpr uint32_t m_nCursorValueB = 0x18C; // int32
    }

    namespace FakeEntity_t {
        constexpr uint32_t m_nHandle = 0x0; // PulseTestEHandle_t
        constexpr uint32_t m_Name = 0x8; // CUtlString
        constexpr uint32_t m_Class = 0x10; // CUtlString
        constexpr uint32_t m_bDestroyed = 0x18; // bool
        constexpr uint32_t m_pAssociatedGraphInstance = 0x20; // CPulseGraphInstance_TestDomain*
        constexpr uint32_t m_bFuncWasCalled = 0x28; // bool
        constexpr uint32_t m_fValue = 0x2C; // float32
    }
    ...
    namespace PGDInstruction_t {
        ...
        constexpr uint32_t m_Arg0Name = 0x20; // CUtlSymbolLarge
        constexpr uint32_t m_Arg1Name = 0x28; // CUtlSymbolLarge
        constexpr uint32_t m_bLiteralBool = 0x30; // bool
        constexpr uint32_t m_nLiteralInt = 0x34; // int32
        constexpr uint32_t m_flLiteralFloat = 0x38; // float32
        constexpr uint32_t m_LiteralString = 0x40; // CBufferString
        constexpr uint32_t m_vLiteralVec3 = 0x50; // Vector
    }
