...
public static class C_OP_RenderSprites {
    ...
    public const nint m_flMinSize = 0x25D8; // CParticleCollectionRendererFloatInput
    public const nint m_flMaxSize = 0x2730; // CParticleCollectionRendererFloatInput
    public const nint m_flAlphaAdjustWithSizeAdjust = 0x2888; // CParticleCollectionRendererFloatInput
    public const nint m_flStartFadeSize = 0x29E0; // CParticleCollectionRendererFloatInput
    public const nint m_flEndFadeSize = 0x2B38; // CParticleCollectionRendererFloatInput
    public const nint m_flStartFadeDot = 0x2C90; // float32
    public const nint m_flEndFadeDot = 0x2C94; // float32
    public const nint m_bDistanceAlpha = 0x2C98; // bool
    public const nint m_bSoftEdges = 0x2C99; // bool
    public const nint m_flEdgeSoftnessStart = 0x2C9C; // float32
    public const nint m_flEdgeSoftnessEnd = 0x2CA0; // float32
    public const nint m_bOutline = 0x2CA4; // bool
    public const nint m_OutlineColor = 0x2CA5; // Color
    public const nint m_nOutlineAlpha = 0x2CAC; // int32
    public const nint m_flOutlineStart0 = 0x2CB0; // float32
    public const nint m_flOutlineStart1 = 0x2CB4; // float32
    public const nint m_flOutlineEnd0 = 0x2CB8; // float32
    public const nint m_flOutlineEnd1 = 0x2CBC; // float32
    public const nint m_nLightingMode = 0x2CC0; // ParticleLightingQuality_t
    public const nint m_flLightingTessellation = 0x2CC8; // CParticleCollectionRendererFloatInput
    public const nint m_flLightingDirectionality = 0x2E20; // CParticleCollectionRendererFloatInput
    public const nint m_bParticleShadows = 0x2F78; // bool
    public const nint m_flShadowDensity = 0x2F7C; // float32
}
