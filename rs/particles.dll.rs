...
pub mod C_OP_RenderSprites {
    ...
    pub const m_flMinSize: usize = 0x25D8; // CParticleCollectionRendererFloatInput
    pub const m_flMaxSize: usize = 0x2730; // CParticleCollectionRendererFloatInput
    pub const m_flAlphaAdjustWithSizeAdjust: usize = 0x2888; // CParticleCollectionRendererFloatInput
    pub const m_flStartFadeSize: usize = 0x29E0; // CParticleCollectionRendererFloatInput
    pub const m_flEndFadeSize: usize = 0x2B38; // CParticleCollectionRendererFloatInput
    pub const m_flStartFadeDot: usize = 0x2C90; // float32
    pub const m_flEndFadeDot: usize = 0x2C94; // float32
    pub const m_bDistanceAlpha: usize = 0x2C98; // bool
    pub const m_bSoftEdges: usize = 0x2C99; // bool
    pub const m_flEdgeSoftnessStart: usize = 0x2C9C; // float32
    pub const m_flEdgeSoftnessEnd: usize = 0x2CA0; // float32
    pub const m_bOutline: usize = 0x2CA4; // bool
    pub const m_OutlineColor: usize = 0x2CA5; // Color
    pub const m_nOutlineAlpha: usize = 0x2CAC; // int32
    pub const m_flOutlineStart0: usize = 0x2CB0; // float32
    pub const m_flOutlineStart1: usize = 0x2CB4; // float32
    pub const m_flOutlineEnd0: usize = 0x2CB8; // float32
    pub const m_flOutlineEnd1: usize = 0x2CBC; // float32
    pub const m_nLightingMode: usize = 0x2CC0; // ParticleLightingQuality_t
    pub const m_flLightingTessellation: usize = 0x2CC8; // CParticleCollectionRendererFloatInput
    pub const m_flLightingDirectionality: usize = 0x2E20; // CParticleCollectionRendererFloatInput
    pub const m_bParticleShadows: usize = 0x2F78; // bool
    pub const m_flShadowDensity: usize = 0x2F7C; // float32
}
